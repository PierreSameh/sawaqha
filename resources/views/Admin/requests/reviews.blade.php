...
@section("title", "Requests - Under Review")

@php
    $requests = App\Models\Money_request::latest()->with("user")->where("status", 1)->paginate(15);
@endphp
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Requests - Under Review</h1>
</div>
