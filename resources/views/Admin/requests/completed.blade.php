...
@section("title", "Requests - Completed")

@php
    $requests = App\Models\Money_request::latest()->with("user")->where("status", 2)->paginate(15);
@endphp
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Requests - Completed</h1>
</div>
