...
<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{route('admin.store.rates')}}" method="POST">
                ...
                <button type="submit" class="btn btn-primary">Add Shipping Rate</button>
            </form>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">Existing Shipping Rates</div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('admin.edit.rates', $rate->id)}}" class="btn btn-sm btn-warning">Edit</a>
